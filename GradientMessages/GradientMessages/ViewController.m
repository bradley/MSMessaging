...
- (MessageBubbleViewModel *)messageBubbleViewModelForMessageText:(NSString *)messageText isAuthor:(BOOL)isAuthor;
...
- (CGSize)sizeForItemAtIndexPath:(NSIndexPath *)indexPath
{
	...
	MessageBubbleViewModel *viewModel = [self messageBubbleViewModelForMessageText:message.messageText isAuthor:message.isAuthor];
